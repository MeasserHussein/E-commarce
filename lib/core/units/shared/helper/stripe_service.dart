...
import 'package:comamarce/core/units/shared/helper/api_stripe_service.dart';
...
class StripeService {
  final ApiStripeService apiStripeService = ApiStripeService();

  Future<PaymentIntentModel> createPaymentIntent(
      PaymentIntentInputModel paymentIntentInputModel) async {
    var responsive = await apiStripeService.stripePost(
