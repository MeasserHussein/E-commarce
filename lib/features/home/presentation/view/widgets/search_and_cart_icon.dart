...
class SearchAndCartIcon extends StatelessWidget {
  const SearchAndCartIcon({super.key,});
      ...
      children: [
        Expanded(
          child: AppTextFormField(
            ...
            prefixIcon: Image.asset('assets/icons/search.png',color: AppColors.primaryBlueColor,),
          ...
          onTap: (){
            ...
            child: badges.Badge(
              badgeAnimation: const badges.BadgeAnimation.fade(
                ...
                badgeStyle:const badges.BadgeStyle(badgeColor: AppColors.primaryBlueColor) ,
              badgeContent:state.whenOrNull(
                  addSuccess:(add)=>
                Text(add.numOfCartItems.toString(),style: const TextStyle(color: Colors.white),)),
                child: Image.asset('assets/icons/cart.png',color: AppColors.primaryBlueColor,))),
      ],
    );
  },
);
